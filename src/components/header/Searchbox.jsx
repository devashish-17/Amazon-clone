...
const Searchbox = () => {
  return (
    <div className="flex flex-grow px-4 md:px-0 h-8 md:h-10">
      ...
      <input type="text" name="" className="w-full text-black outline-none px-3 font-semibold rounded-l-md md:rounded-none" placeholder="Search Amazon.in" />
